...
def skewT_plot(df, pressure, temperature, dewpoint, uwind, vwind,
    ...
    plt.figtext(0.60, 0.75, 'SBCAPE: ', weight='bold', fontsize=15,
                color='black', ha='left')
    plt.figtext(0.77, 0.75, f'{sbcape:.0f~P}', weight='bold',
                fontsize=15, color='orangered', ha='right')
    
    plt.figtext(0.60, 0.70, 'SBCIN: ', weight='bold',
                fontsize=15, color='black', ha='left')
    plt.figtext(0.77, 0.70, f'{sbcin:.0f~P}', weight='bold',
                fontsize=15, color='lightblue', ha='right')
    
    plt.figtext(0.60, 0.65, 'MLCAPE: ', weight='bold', fontsize=15,
                color='black', ha='left')
    plt.figtext(0.77, 0.65, f'{mlcape:.0f~P}', weight='bold',
                fontsize=15, color='orangered', ha='right')
    
    plt.figtext(0.60, 0.60, 'MLCIN: ', weight='bold', fontsize=15,
                color='black', ha='left')
    plt.figtext(0.77, 0.60, f'{mlcin:.0f~P}', weight='bold',
                fontsize=15, color='lightblue', ha='right')
    
    plt.figtext(0.60, 0.55, 'MUCAPE: ', weight='bold', fontsize=15,
                color='black', ha='left')
    plt.figtext(0.77, 0.55, f'{mucape:.0f~P}', weight='bold',
                fontsize=15, color='orangered', ha='right')
    
    plt.figtext(0.60, 0.50, 'MUCIN: ', weight='bold', fontsize=15,
                color='black', ha='left')
    plt.figtext(0.77, 0.50, f'{mucin:.0f~P}', weight='bold',
                fontsize=15, color='lightblue', ha='right')
    
    plt.figtext(0.60, 0.45, 'TT-INDEX: ', weight='bold', fontsize=15,
                color='black', ha='left')
    plt.figtext(0.77, 0.45, f'{totals_index:.0f~P}', weight='bold',
                fontsize=15, color='orangered', ha='right')
    
    plt.figtext(0.60, 0.40, 'K-INDEX: ', weight='bold', fontsize=15,
                color='black', ha='left')
    plt.figtext(0.77, 0.40, f'{kindex:.0f~P}', weight='bold',
                fontsize=15, color='orangered', ha='right')
